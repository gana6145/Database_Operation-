...
public class DataBaseDriver {
	...
	public static void main(String[] args) {
		...
		DB1.addStudent("Rani", 31, 2025, "BE", 76, "A+", 'M', 10);
		DB1.addStudent("Ganesh", 41, 2025, "BE", 76, "B+", 'f', 12);
		DB1.addStudent("shrikant", 51, 2025, "BE", 76, "AB+", 'M', 13);
		DB1.addStudent("Tejas", 51, 2025, "BE", 76, "B+", 'M', 14);
		DB1.addStudent("om", 54, 2025, "BE", 76, "B+", 'M', 15);
